...
with DAG(
          ...
          BEGIN
              IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = '{table_name}') THEN
                CREATE TABLE {warehouse_schema_staging}.{table_name} (
                    ...
                    user_state varchar(100) DEFAULT 'ACTIVE'::character varying NOT NULL
                );
              ELSE
    ...
    columns = (
        "created_at, deleted_at, is_admin, user_id, community_id, state, user_state"
    )
