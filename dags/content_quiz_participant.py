...
source_table_name = "quiz_participants"
destination_table_name = "quiz_participant"
...
with DAG(
          ...
          BEGIN
              IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = '{destination_table_name}') THEN
                CREATE TABLE {warehouse_schema_staging}.{destination_table_name} (
                    ...
                    , score int4 NULL
                    , total_answers int4 NULL
                    , total_correct_answers int4 NULL
    ...
    columns = "id, quiz_id, post_id, time_limit, score, total_answers, total_correct_answers, started_at, finished_at, updated_by, created_at"
